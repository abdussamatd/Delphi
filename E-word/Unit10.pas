...
begin
score:=0;
if radiogroup1.ItemIndex=3 then score:=score+1;
if radiogroup2.ItemIndex=0 then score:=score+1;
if radiogroup3.ItemIndex=2 then score:=score+1;
if radiogroup4.ItemIndex=0 then score:=score+1;
...
procedure TForm10.RadioGroup10Click(Sender: TObject);
begin
button1.Show;
end;
